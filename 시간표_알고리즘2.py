...
BLOCKS: Dict[str, Block] = {
    ...
    "4A2": Block("4A2", ((1, 1), (1, 2), (3, 3), (3, 4))),                  # 화12, 목34
    "4B2": Block("4B2", ((2, 3), (2, 4), (4, 1), (4, 2))),                  # 수34, 금12
    "4C2": Block("4C2", ((0, 3), (0, 4), (2, 1), (2, 2))),                  # 월34, 수12
    "4D2": Block("4D2", ((0, 1), (0, 2), (3, 7), (4, 5))),                  # 월12, 목7, 금5
    "4E2": Block("4E2", ((1, 6), (1, 7), (4, 6), (4, 7))),                  # 화67, 금67
    "4F2": Block("4F2", ((0, 6), (0, 7), (3, 1), (3, 2))),                  # 월67, 목12
    "4G2": Block("4G2", ((2, 5), (2, 6), (4, 3), (4, 4))),                  # 수56, 금34
    "4H2": Block("4H2", ((0, 5), (1, 5), (3, 5), (3, 6))),                  # 월5, 화5, 목56

    "2A2": Block("2A2", ((1, 3), (1, 4))),                                  # 화34
    "2D2": Block("2D2", ((3, 1), (3, 2))),                                  # 목12
    "2F2": Block("2F2", ((4, 6), (4, 7))),                                  # 금67
    "2B2": Block("2B2", ((0, 6), (0, 7))),                                  # 월67
    "2C2": Block("2C2", ((1, 6), (1, 7))),                                  # 화67
    "2E2": Block("2E2", ((3, 3), (3, 4))),                                  # 목34
