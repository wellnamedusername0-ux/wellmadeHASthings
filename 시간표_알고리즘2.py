...
ALL_COURSE_OPTIONS: Dict[str, List[str]] = {
    # 국어 / 영어 / 수학
    "화법과 언어": ["4A2", "4B2", "4C2", "4D2", "4F2", "4G2", "4H2"],
    "심화 영어 독해Ⅰ": ["4A2", "4B2", "4C2", "4E2", "4G2"],
    "미적분Ⅱ": ["4B2", "4C2", "4D2", "4E2", "4G2", "4H2"],
    "확률과 통계": ["4A2", "4B2", "4D2", "4E2", "4F2", "4G2", "4H2"],
    ...
    "지구시스템과학": ["4B2"],
    "물질과 에너지": ["4G2"],
    "역학과 에너지": ["4B2", "4D2", "4E2", "4H2"],
    "AP일반화학Ⅱ": ["4A2", "4C2", "4D2", "4F2", "4H2"],
    "AP일반물리Ⅰ": ["4C2", "4F2", "4G2"],
    "AP일반생물학Ⅱ": ["4D2", "4E2", "4F2", "4H2"],

    # 언어 / AP / 정보
    "AP 영문학Ⅰ": ["4C2"],
    "일본어 독해와 작문Ⅰ": ["4D2"],
    "중국어 독해와 작문Ⅰ": ["4D2"],
    "인공지능을 위한 선형대수학": ["4C2", "4D2", "4G2"],
    "데이터 과학과 인공지능": ["4E2", "4F2"],
    ...
    "자아탐색과 글쓰기": ["2A2"],
    "글로벌 이슈 세미나2": ["2D2"],
    "주제 탐구 (R&E) 심화": ["2D2", "2E2"],
    "스포츠 생활1(남)": ["2A2", "2B2", "2C2", "2E2"],
    "스포츠 생활1(여)": ["2A2", "2B2", "2C2", "2E2"],
    "탐구 프로젝트(R&E)Ⅰ": ["2A2", "2F2"],
}
